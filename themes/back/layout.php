...
<!--                <div class="preloader">
                    <div class="loading">
                        <center>
                            <img src="<?= base_url('assets/img/' . $row_kab->logo); ?>" class="img-responsive hidden-mobile hidden-xs " width="50%">
                            <img src="<?= base_url('assets/img/' . $row_kab->logo); ?>" class="img-responsive hidden-lg hidden-md hidden-sm " width="40%">
        ...
        <div class="page-footer bg-black-gradient" >
            <?= $footer; ?>
        </div>
        <!-- END PAGE FOOTER -->
